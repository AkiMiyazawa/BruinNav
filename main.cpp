...
////  Map Project
////
////  Created by Allen Miyazawa on 3/9/17.
...
//{
//    Navigator sq;
//    sq.loadMapData("/Users/allenmiyazawa/Desktop/Project 4/Project 4/mapdata.txt");
//    vector<NavSegment> ss;
//    sq.navigate("Harvard-Westlake Middle School", "GreyStone Mansion", ss);
//    for (int i = 0; i < ss.size();i++)
//    {
//        cout << ss[i].m_streetName << endl;
//        cout << ss[i].m_distance << endl;
//        cout << ss[i].m_command << endl;
//        cout << ss[i].m_direction << endl;
//        cout << ss[i].m_geoSegment.start.latitudeText << ", " <<  ss[i].m_geoSegment.start.longitudeText<< endl <<
//        ss[i].m_geoSegment.end.latitudeText << ", " <<  ss[i].m_geoSegment.end.longitudeText<< endl << endl;
//    }
//
//}
...
template<typename T>
string directionOfLine(const T& s)
{
...
//    
    ...
    if ( ! nav.loadMapData("/Users/allenmiyazawa/Desktop/Project 4/Project 4/mapdata.txt"))
    {
    ...
    string start = "Diddy Riese";
    string end = "Hitch Residential Suites";
